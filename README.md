...
- 使用月份标题两侧的箭头查看其他月份，并显示截至所选日期的当月累计工资。
- 支持开机自启动。
- 界面支持简体中文、英语、日语、韩语和俄语，并自动跟随 macOS 的 App 语言。

## 1.2.1 更新

- 月份标题两侧增加切换箭头，可浏览上个月和下个月。
- 选中日期后，右侧显示该月份从 1 日累计到所选日期的工资。
- 固定月历为六行布局，并优化纵向间距，避免底部图例被裁切。
- 月份切换和累计标题同步支持简体中文、英语、日语、韩语和俄语。
...
1. 点击菜单栏中的金额，打开工资面板。
2. 使用月份标题两侧的箭头切换月份。
3. 左键点击月历日期，上方左侧显示当天工资，右侧显示该月截至所选日期的累计工资。
4. 右键点击月历日期，在菜单中标记或取消当天加班。
5. 点击右上角齿轮，设置时薪、作息、休息制度和刷新频率。
6. 返回主面板后，今日与本月金额会按新规则自动更新。
